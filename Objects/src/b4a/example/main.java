...
anywheresoftware.b4a.keywords.Common.LogImpl("1327689",_j1._getstring /*String*/ (null),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("1327703",BA.NumberToString(_res._base_experience /*int*/ ),0);
RDebugUtils.currentLine=327704;
 //BA.debugLineNum = 327704;BA.debugLine="Log(res.height)";
anywheresoftware.b4a.keywords.Common.LogImpl("1327704",BA.NumberToString(_res._height /*int*/ ),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("1327706","     "+_f._name /*String*/ ,0);
RDebugUtils.currentLine=327707;
 //BA.debugLineNum = 327707;BA.debugLine="Log(\"     \" & f.url)";
anywheresoftware.b4a.keywords.Common.LogImpl("1327707","     "+_f._url /*String*/ ,0);
 if (true) break;
if (true) break;
;
...
anywheresoftware.b4a.keywords.Common.LogImpl("1327710","     "+BA.ObjectToString(_a._is_hidden /*boolean*/ ),0);
RDebugUtils.currentLine=327711;
 //BA.debugLineNum = 327711;BA.debugLine="Log(\"     \" & a.slot)";
anywheresoftware.b4a.keywords.Common.LogImpl("1327711","     "+BA.NumberToString(_a._slot /*int*/ ),0);
RDebugUtils.currentLine=327712;
 //BA.debugLineNum = 327712;BA.debugLine="Log(\"     \" & a.ability.name)";
anywheresoftware.b4a.keywords.Common.LogImpl("1327712","     "+_a._ability /*b4a.example.ability*/ ._name /*String*/ ,0);
RDebugUtils.currentLine=327713;
 //BA.debugLineNum = 327713;BA.debugLine="Log(\"     \" & a.ability.url)";
anywheresoftware.b4a.keywords.Common.LogImpl("1327713","     "+_a._ability /*b4a.example.ability*/ ._url /*String*/ ,0);
 if (true) break;
if (true) break;
...
RDebugUtils.currentLine=4194304;
 //BA.debugLineNum = 4194304;BA.debugLine="Public Sub GetForms( table As List) As List";
RDebugUtils.currentLine=4194305;
 //BA.debugLineNum = 4194305;BA.debugLine="Dim lst As List : lst.initialize";
_lst = new anywheresoftware.b4a.objects.collections.List();
RDebugUtils.currentLine=4194305;
 //BA.debugLineNum = 4194305;BA.debugLine="Dim lst As List : lst.initialize";
_lst.Initialize();
RDebugUtils.currentLine=4194306;
 //BA.debugLineNum = 4194306;BA.debugLine="For i = 0 To table.Size-1";
{
final int step3 = 1;
...
RDebugUtils.currentLine=4194307;
 //BA.debugLineNum = 4194307;BA.debugLine="Dim f As form :  f.Initialize";
_f = new b4a.example.form();
RDebugUtils.currentLine=4194307;
 //BA.debugLineNum = 4194307;BA.debugLine="Dim f As form :  f.Initialize";
_f._initialize /*String*/ (null,processBA);
RDebugUtils.currentLine=4194308;
 //BA.debugLineNum = 4194308;BA.debugLine="Dim m As Map = table.Get(i)";
...
RDebugUtils.currentLine=4194309;
 //BA.debugLineNum = 4194309;BA.debugLine="f.name = m.Get(\"name\")";
_f._name /*String*/  = BA.ObjectToString(_m.Get((Object)("name")));
RDebugUtils.currentLine=4194310;
 //BA.debugLineNum = 4194310;BA.debugLine="f.url = m.Get(\"url\")";
_f._url /*String*/  = BA.ObjectToString(_m.Get((Object)("url")));
RDebugUtils.currentLine=4194311;
 //BA.debugLineNum = 4194311;BA.debugLine="lst.Add(f)";
_lst.Add((Object)(_f));
 }
};
RDebugUtils.currentLine=4194313;
 //BA.debugLineNum = 4194313;BA.debugLine="Return lst";
if (true) return _lst;
...
RDebugUtils.currentLine=4784128;
 //BA.debugLineNum = 4784128;BA.debugLine="Public Sub GetAbilities(table As List) As List";
RDebugUtils.currentLine=4784129;
 //BA.debugLineNum = 4784129;BA.debugLine="Dim lst As List : lst.initialize";
_lst = new anywheresoftware.b4a.objects.collections.List();
RDebugUtils.currentLine=4784129;
 //BA.debugLineNum = 4784129;BA.debugLine="Dim lst As List : lst.initialize";
_lst.Initialize();
RDebugUtils.currentLine=4784130;
 //BA.debugLineNum = 4784130;BA.debugLine="For i = 0 To table.Size-1";
{
final int step3 = 1;
final int limit3 = (int) (_table.getSize()-1);
_i = (int) (0) ;
...
RDebugUtils.currentLine=4784131;
 //BA.debugLineNum = 4784131;BA.debugLine="Dim a As abilityItem :  a.Initialize";
_a = new b4a.example.abilityitem();
RDebugUtils.currentLine=4784131;
 //BA.debugLineNum = 4784131;BA.debugLine="Dim a As abilityItem :  a.Initialize";
_a._initialize /*String*/ (null,processBA);
RDebugUtils.currentLine=4784132;
 //BA.debugLineNum = 4784132;BA.debugLine="Dim m As Map = table.Get(i)";
_m = new anywheresoftware.b4a.objects.collections.Map();
_m = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (java.util.Map)(_table.Get(_i)));
RDebugUtils.currentLine=4784133;
 //BA.debugLineNum = 4784133;BA.debugLine="a.is_hidden = m.Get(\"is_hidden\")";
_a._is_hidden /*boolean*/  = BA.ObjectToBoolean(_m.Get((Object)("is_hidden")));
RDebugUtils.currentLine=4784134;
 //BA.debugLineNum = 4784134;BA.debugLine="a.slot = m.Get(\"slot\")";
_a._slot /*int*/  = (int)(BA.ObjectToNumber(_m.Get((Object)("slot"))));
RDebugUtils.currentLine=4784136;
 //BA.debugLineNum = 4784136;BA.debugLine="Dim m2 As Map = m.Get(\"ability\")";
