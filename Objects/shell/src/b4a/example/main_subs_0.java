...
parent.mostCurrent.__c.runVoidMethod ("LogImpl","1327689",_j1.runClassMethod (b4a.example.httpjob.class, "_getstring" /*RemoteObject*/ ),0);
...
parent.mostCurrent.__c.runVoidMethod ("LogImpl","1327703",BA.NumberToString(_res.getField(true,"_base_experience" /*RemoteObject*/ )),0);
 BA.debugLineNum = 61;BA.debugLine="Log(res.height)";
Debug.ShouldStop(268435456);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","1327704",BA.NumberToString(_res.getField(true,"_height" /*RemoteObject*/ )),0);
...
Debug.ShouldStop(1073741824);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","1327706",RemoteObject.concat(RemoteObject.createImmutable("     "),_f.getField(true,"_name" /*RemoteObject*/ )),0);
 BA.debugLineNum = 64;BA.debugLine="Log(\"     \" & f.url)";
Debug.ShouldStop(-2147483648);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","1327707",RemoteObject.concat(RemoteObject.createImmutable("     "),_f.getField(true,"_url" /*RemoteObject*/ )),0);
 if (true) break;
if (true) break;
Debug.locals.put("f", _f);
;
...
Debug.ShouldStop(4);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","1327710",RemoteObject.concat(RemoteObject.createImmutable("     "),_a.getField(true,"_is_hidden" /*RemoteObject*/ )),0);
 BA.debugLineNum = 68;BA.debugLine="Log(\"     \" & a.slot)";
Debug.ShouldStop(8);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","1327711",RemoteObject.concat(RemoteObject.createImmutable("     "),_a.getField(true,"_slot" /*RemoteObject*/ )),0);
 BA.debugLineNum = 69;BA.debugLine="Log(\"     \" & a.ability.name)";
Debug.ShouldStop(16);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","1327712",RemoteObject.concat(RemoteObject.createImmutable("     "),_a.getField(false,"_ability" /*RemoteObject*/ ).getField(true,"_name" /*RemoteObject*/ )),0);
 BA.debugLineNum = 70;BA.debugLine="Log(\"     \" & a.ability.url)";
Debug.ShouldStop(32);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","1327713",RemoteObject.concat(RemoteObject.createImmutable("     "),_a.getField(false,"_ability" /*RemoteObject*/ ).getField(true,"_url" /*RemoteObject*/ )),0);
 if (true) break;
if (true) break;
